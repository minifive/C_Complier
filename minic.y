...
%token	INT FLOAT NAME STRUCT IF ELSE RETURN NUMBER LPAR RPAR LBRACE RBRACE/*∂®“Â÷’Ω·∑˚*/
...
statement	: IF LPAR exp RPAR statement 		LOW
...
exp		: exp DOT NAME		{ $$ = check_record_access($1,$3); }
		...
		| LPAR exp RPAR	{ $$ = $2; }
		| MINUS exp UMINUS /* this will force a reduce */
